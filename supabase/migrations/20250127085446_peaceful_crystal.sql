/*
  # Scoreboards table with complete RLS policies
  ...
  2. Security
    ...
    - Allow deactivating scoreboards
*/
...
-- Allow anyone to update scoreboards
...
-- Allow anyone to delete/deactivate scoreboards
CREATE POLICY "Anyone can delete scoreboards"
  ON scoreboards
  FOR DELETE
  TO public
  USING (true);
